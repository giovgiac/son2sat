...
tf.flags.DEFINE_string("weights_file", "vgg16.npz", "Weights for the VGG16 network.")
tf.flags.DEFINE_integer("batch_size", 8, "Batch size to use for the network.")
tf.flags.DEFINE_integer("gen_filters", 16, "Parameter that scales the size of the network.")
